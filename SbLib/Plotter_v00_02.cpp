...
double Plotter_v00_02::Operate(LogicParam* pParam)
{
	//	座標取得
	CalculateInfo_v00_02 calInfo;
	...
	double dx = calInfo.vec.dx;
	double dy = calInfo.vec.dy;
	double dz = calInfo.vec.dz;
	...
	{
	case 1:
		dResult = sin((2.3 + dd) * dy) + (3.108 * cos((2.8 - dd) * dx)) / dy;
		break;
	case 2:
		dResult = (dx * 1.2) * (dy) + (dx * 3);//cos(dx) - (4.008 * sin(dy));
		break;
	case 3:
		dResult = dx * dy / 1.0;
		break;
...
void Plotter_v00_02::PostOperate(LogicParam* pParam1, double* pdX, LogicParam* pParam2, double* pdY, LogicParam* pParam3, double* pdZ, int nFrame)
{
...
double Plotter_v00_02::Calculate(char** ppAlgo, void* pInfo)
{
	CalculateInfo_v00_02 info = *(CalculateInfo_v00_02*)pInfo;
...
char* Plotter_v00_02::ConstructAlgo(void* AlgoInfo)
{
	...
	ExpInfo_v00_02 info1;
	info1.nDim = 1;
	SetExp(m_param.strArg1, &info1);

	ExpInfo_v00_02 info2;
	info2.nDim = 2;
	SetExp(m_param.strArg2, &info2);

	ExpInfo_v00_02 info3;
	info3.nDim = 1;
...
bool Plotter_v00_02::ReadAlgo(void* AlgoInfo, int nSeedIndex)
{
	bool fFind = false;
...
char* Plotter_v00_02::SetExp(char* pDest, void* pInfo)
{
	ExpInfo_v00_02 info = *(ExpInfo_v00_02*)pInfo;
...
char* Plotter_v00_02::SetParam(char* pDest, void* pInfo)
{
...
char* Plotter_v00_02::SetArg(char* pDest, void* pInfo)
{
	ArgInfo_v00_02 info = *(ArgInfo_v00_02*)pInfo;
...
char* Plotter_v00_02::SetOp(char* pDest, void* pInfo)
{
	ArgInfo_v00_02 info;
...
void Plotter_v00_02::SaveAlgo(const char* strFileName)
{
	FILE* fp;
